...
.mk-shop-hero-card-sub{ color:#8A7F73; font-size:1.0rem; margin:2px 0 0; }
...
/* ---------------- Kategori Belanja ---------------- */
.mk-category{ background:#F7F5F1; padding:70px 24px; }
...
.mk-category-overlay-title{ color:#FFFFFF; font-weight:700; font-size:1.3rem; margin:0 0 4px; }
.mk-category-overlay-desc{ color:#F1EEEA; font-size:1.2rem; margin:0; line-height:1.4; }
...
.mk-app-topbar{ display:flex; align-items:center; justify-content:space-between; padding:20px 16px 12px; }
.mk-app-topbar-icon{ color:#2E2620; font-size:1.1rem; }
.mk-app-logo{ font-weight:800; font-size:1rem; }
.mk-app-logo-manna{ color:#C9611F; }
.mk-app-logo-kampus{ color:#1C1C1C; }
.mk-app-logo-sub{ display:block; color:#8A7F73; font-size:1.0rem; font-weight:700; letter-spacing:0.5px; }
		...
		<div class="mk-app-phone">
			<div class="mk-app-screen">
				...
				<div class="mk-app-topbar">
					...
					<span class="mk-app-logo"><span class="mk-app-logo-manna">Manna</span> <span class="mk-app-logo-kampus">Kampus</span><span class="mk-app-logo-sub">RUMAH BELANJA TERPERCAYA</span></span>
