...
// ambil data tenant yang mau diedit
...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['nama_stand'])) {
        $valid = 0;
        $error_message .= "Tenant name can not be empty<br>";
    }

    if($valid == 1) {
        $statement = $pdo->prepare("UPDATE tbl_cabang_stand SET id_cabang=?, nama_stand=?, deskripsi=?, icon=? WHERE id=?");
        ...
        $_SESSION['success_message'] = 'Branch tenant is updated successfully.';
        header('Location: branch-tenants.php');
        exit;
    }

    $data['id_cabang'] = $_POST['id_cabang'];
    $data['nama_stand'] = $_POST['nama_stand'];
...
<section class="content-header" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap;">
    <div class="content-header-left">
        <h1 style="margin:0;">Edit Branch Tenant</h1>
    </div>
        <a href="branch-tenants.php" class="btn btn-primary btn-sm no-plus-icon"><i class="fa fa-arrow-left" style="text-align: center;"></i> View All</a>
</section>
            ...
            <form class="form-horizontal" action="" method="post">
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Tenant <span>*</span></label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="nama_stand" value="<?php echo htmlspecialchars($data['nama_stand'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Example: Coffee Shop">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" name="icon" id="branch-tenant-icon-select">
                                ...
                                <p class="help-block">Pilih icon untuk tenant dari opsi.</p>
                                <div id="branch-tenant-icon-preview" style="margin-top:8px;">
...
document.addEventListener('DOMContentLoaded', function() {
    var iconSelect = document.getElementById('branch-tenant-icon-select');
    var previewBox = document.querySelector('#branch-tenant-icon-preview .icon-preview-box');
    var previewText = document.querySelector('#branch-tenant-icon-preview .icon-preview-text');
