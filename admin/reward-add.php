                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="prize_name" value="<?php echo htmlspecialchars($_POST['prize_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Example: Sepeda Motor Scoopy">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" name="grand_prize">
                                    <option value="0" <?php echo (isset($_POST['grand_prize']) && $_POST['grand_prize'] == '0') ? 'selected' : ''; ?>>No</option>
                                    <option value="1" <?php echo (isset($_POST['grand_prize']) && $_POST['grand_prize'] == '1') ? 'selected' : ''; ?>>Yes</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="number" class="form-control" name="qty" value="<?php echo htmlspecialchars($_POST['qty'] ?? '1', ENT_QUOTES, 'UTF-8'); ?>" min="1">
                            </div>
                        </div>
