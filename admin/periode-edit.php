...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        $statement = $pdo->prepare("UPDATE tbl_periode SET id_program=?, periode_name=?, draw_date=? WHERE id=?");
        ...
        $_SESSION['success_message'] = 'Periode updated successfully.';
        header('Location: periode.php');
        exit;
    }

    $data['id_program']   = $_POST['id_program'];
    $data['periode_name'] = $_POST['periode_name'];
    $data['draw_date']    = $_POST['draw_date'];
}
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="periode_name" value="<?php echo htmlspecialchars($data['periode_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Example: Periode I">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="date" class="form-control" name="draw_date" value="<?php echo htmlspecialchars($data['draw_date'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                            </div>
                        </div>
