...
<section class="content-header">
    <div class="content-header-left">
        <h1>Branch Tenants</h1>
    </div>
    <div class="content-header-right">
        <a href="branch-tenants-add.php" class="btn btn-primary btn-sm">Add New</a>
    </div>
</section>
            ...
            <tbody>
                ...
                foreach ($result as $row) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="branch-tenants-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs">Edit</a>
                            <a href="#" class="btn btn-danger btn-xs" data-href="branch-tenants-delete.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
                        </td>
                    </tr>
                    <?php
                }
