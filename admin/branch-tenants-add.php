...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        $statement = $pdo->prepare("INSERT INTO tbl_cabang_stand (id_cabang, nama_stand, deskripsi, icon) VALUES (?,?,?,?)");
        ...
        $_SESSION['success_message'] ='Branch tenant is added successfully.';
...
<section class="content-header" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap;">
    <div class="content-header-left">
        <h1 style="margin:0;">Add Branch Tenant</h1>
    </div>
    <div class="content-header-right">
        <a href="branch-tenants.php" class="btn btn-primary btn-sm">View All</a>
    </div>
</section>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="nama_stand" value="<?php echo htmlspecialchars($_POST['nama_stand'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Example: Coffee Shop">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <p class="help-block">Pilih icon untuk tenant. Jika ingin mengganti, pilih salah satu opsi yang tersedia.</p>
